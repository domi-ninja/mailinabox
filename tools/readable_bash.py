...
<html>
    ...
    <div class="container">
      <div class="row intro">
        ...
        <p>This document is generated automatically from <a href="https://mailinabox.email">Mail-in-a-Box</a>&rsquo;s setup script <a href="https://github.com/domi-ninja/mailinabox">source code</a>.</p>
        <hr>
      </div>
    </div>
...
class BashScript(Grammar):
	...
	def parse(fn):
		...
		v = "<div class='row'><div class='col-xs-12 sourcefile'>view the bash source for the following section at <a href=\"%s\">%s</a></div></div>\n" \
			 % ("https://github.com/domi-ninja/mailinabox/tree/master/" + fn, fn)
